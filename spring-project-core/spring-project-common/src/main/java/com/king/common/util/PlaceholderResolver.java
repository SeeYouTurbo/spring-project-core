...
public class PlaceholderResolver {
     ...
     */
    private static PlaceholderResolver getDefaultResolver() {
     ...
     * @return
     */
    private String resolve(String content, String... values) {
     ...
     * @return String
     */
    private String resolveByRule(String content, Function<String, String> rule) {
        int start = content.indexOf(this.placeholderPrefix);
        if (start == -1) {
            return content;
        }
     ...
     * @return   替换完成后的字符串。
     */
    private String resolveByMap(String content, final Map<String, Object> valueMap) {
    ...
    public static void main(String[] args) {
        PlaceholderResolver.getDefaultResolver().resolve("https://api.weixin.qq.com/sns/oauth2/access_token?appid=${appid}&secret=${secret}&code=${code}&grant_type=authorization_code"
                , "weiXinAppId", "weiXinSecret", "code");
